...
from .serializers import (
    ...
    W2WithholdingSerializer, PreTaxDeductionSerializer, PostTaxDeductionSerializer, SelfEmploymentTaxSerializer
)
...
class W2WithholdingViewSet(viewsets.ModelViewSet):
    """ViewSet for managing W2 withholding configurations."""
    permission_classes = [IsAuthenticated]
