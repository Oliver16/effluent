...
## Objective
Create comprehensive recurring income and expense models with detailed categorization, separating mortgage from rent for balance sheet accuracy.
...
2. Comprehensive IncomeCategory enum
3. Comprehensive ExpenseCategory enum (mortgage vs rent separated)
4. Frequency handling with monthly/annual conversions
5. Category groupings for analysis
...
2. Test in Django shell:
   ...
   print(f"Biweekly $1000 = ${flow.monthly_amount:.2f}/month")
   print(f"Biweekly $1000 = ${flow.annual_amount:.2f}/year")
...
## Acceptance Criteria
- [ ] All income categories defined
- [ ] All expense categories defined  
- [ ] Mortgage and Rent are separate categories
- [ ] Category groupings correct (housing, essential, fixed, debt)
- [ ] Frequency conversions accurate
- [ ] RecurringFlow links to accounts, members, income sources
